  ...
  _createClass(Logger, [{
    ...
    value: function configure() {
      ...
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          _ref$useMetaKey = _ref.useMetaKey,
          useMetaKey = _ref$useMetaKey === void 0 ? false : _ref$useMetaKey,
          _ref$enableSplat = _ref.enableSplat,
          enableSplat = _ref$enableSplat === void 0 ? false : _ref$enableSplat;
      ...
      this.enableSplat = enableSplat; // Add all transports we have been provided.
    ...
    value: function log(level, msg) {
      ...
      if (arguments.length === 1) {
        ...
        level = this._mergeInfo(null
        /* no meta */
        , level); // don't mutate the incoming object
      ...
      if (arguments.length === 2) {
        var _this$_mergeInfo;

        if (msg && _typeof(msg) === 'object') {
          msg[LEVEL] = msg.level = level;
          msg = this._mergeInfo(null
          /* no meta */
          , msg);
          this.write(msg);
          return this;
        ...
        this.write(this._mergeInfo(null
        /* no meta */
        , (_this$_mergeInfo = {}, _defineProperty(_this$_mergeInfo, LEVEL, level), _defineProperty(_this$_mergeInfo, "level", level), _defineProperty(_this$_mergeInfo, "message", msg), _this$_mergeInfo)));
        return this;
      }
      ...
      if (_typeof(meta) === 'object' && meta !== null) {
        ...
        var tokens = this.enableSplat && msg && msg.match && msg.match(formatRegExp);

        if (!tokens) {
          var _this$_mergeInfo2;

          var info = this._mergeInfo(meta, (_this$_mergeInfo2 = {}, _defineProperty(_this$_mergeInfo2, LEVEL, level), _defineProperty(_this$_mergeInfo2, SPLAT, splat.splice(1)), _defineProperty(_this$_mergeInfo2, "level", level), _defineProperty(_this$_mergeInfo2, "message", msg), _this$_mergeInfo2));
      ...
      this.write(this._mergeInfo(null
      /* no meta */
      , (_this$_mergeInfo3 = {}, _defineProperty(_this$_mergeInfo3, LEVEL, level), _defineProperty(_this$_mergeInfo3, SPLAT, splat), _defineProperty(_this$_mergeInfo3, "level", level), _defineProperty(_this$_mergeInfo3, "message", msg), _this$_mergeInfo3)));
      return this;
    }
    /**
    ...
    key: "_mergeInfo",
    value: function _mergeInfo(meta, msg) {
      var overrides = [];

      if (this.defaultMeta) {
        if (this.useMetaKey) {
          overrides.push(_defineProperty({}, this.useMetaKey, this.defaultMeta));
        } else {
          overrides.push(this.defaultMeta);
        }
      }

      if (meta) {
        if (this.useMetaKey) {
          overrides.push(_defineProperty({}, this.useMetaKey, meta));
        } else {
          overrides.push(meta);
        }
      }
      ...
      return overrides.length > 0 ? Object.assign.apply(Object, [{}].concat(overrides)) : {};
    }
  }]);
